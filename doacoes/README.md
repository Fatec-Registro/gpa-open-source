...
| :--------------------------------------- | :--------------------- | :----------- |
| **Gilmar Soares Franco**                 | Designer/UX            | gilsfranco   |
| **Victor Luís Camargo Aguiar**           | Desenvolvedor Frontend | victorluisca |
| **Lucas Silva de Oliveira**              | Desenvolvedor Frontend | lucasilvaO   |
| **Asher Novelli Bittencourt de Bortoli** | Desenvolvedor Frontend | ashern000    |
